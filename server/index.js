...
await db.exec(`CREATE TABLE IF NOT EXISTS word_cache ( id INTEGER PRIMARY KEY, first_word TEXT, second_word TEXT, result TEXT, emoji TEXT )`);
}
...
const model = new LlamaModel({
    modelPath: path.join(__dirname, "models", "qwen2.5-3b-instruct-Q2_K.gguf"),
    threads: 8,
});
